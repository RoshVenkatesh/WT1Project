...
<body style = "overflow:hidden; background-image: url('assets/poly2.jpg'); background-size: cover;">
...
<br>
<div>
	<div style="display: inline-block; float:left; "><img src = "assets/logo2.png" alt= "PIC!" style ="width :5em; height= 5em;"/></div>
	<div style="display: inline-block;"><center> <img src = "assets/heading4.png" alt= "PIC!" style ="margin-left: 17em; margin-right: 1em" /></center></div>
<!--<p style="display: inline-block; margin-left: -90px ; margin-top: 0px;font-family: 'Aclonica', sans-serif; color:white; font-size:50px;" class="h"> BRAIN AND BEYOND </p>-->
	<div style="display: inline-block; float:right;"><img src = "assets/logo2.png" alt= "PIC!" style ="width :5em; height= 5em;"/></div>
